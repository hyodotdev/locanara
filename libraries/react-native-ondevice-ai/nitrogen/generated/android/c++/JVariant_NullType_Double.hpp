...
namespace margelo::nitro::ondeviceai {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/ondeviceai/Variant_NullType_Double;";
  ...
  namespace JVariant_NullType_Double_impl {
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/ondeviceai/Variant_NullType_Double$First;";
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/ondeviceai/Variant_NullType_Double$Second;";
