  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.row}>
        ...
        >
          <Text
            style={[
              styles.typeText,
              memoryType === 'buffer' && styles.typeTextSel,
            ]}
          >
            Buffer
          </Text>
          <Text
            style={[
              styles.typeDesc,
              memoryType === 'buffer' && styles.typeDescSel,
            ]}
          >
        ...
        <TouchableOpacity
          style={[styles.typeBtn, memoryType === 'summary' && styles.typeSel]}
          onPress={() => {
        ...
        >
          <Text
            style={[
              styles.typeText,
              memoryType === 'summary' && styles.typeTextSel,
            ]}
          >
            Summary
          </Text>
          <Text
            style={[
              styles.typeDesc,
              memoryType === 'summary' && styles.typeDescSel,
            ]}
          >
            Compressed history
          </Text>
      ...
      <View style={styles.badgeRow}>
        ...
        <StatBadge label="In Context" value={`${display.length}`} />
        <StatBadge label="Tokens" value={`~${tokens}`} />
      </View>
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>Memory Entries</Text>
          {history.length > 0 && (
          ...
          display.map((e, i) => (
            <View key={i} style={styles.entryRow}>
              <View
                style={[
                  styles.badge,
                  e.role === 'user' ? styles.badgeUser : styles.badgeAI,
                ]}
              >
      ...
      <View style={styles.inputRow}>
        ...
        />
        <TouchableOpacity
          style={[styles.sendBtn, isProcessing && styles.sendDis]}
          onPress={handleSend}
...
const styles = StyleSheet.create({
  ...
  typeDescSel: {color: 'rgba(255,255,255,0.8)'},
  ...
  badgeUser: {backgroundColor: '#007AFF'},
  badgeAI: {backgroundColor: '#34C759'},
