...
export function SessionDemo() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      console.log(
        '[DEBUG] session chatStream request:',
        JSON.stringify({message: msg, historyLength: currentHistory.length}),
      );
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          <View style={styles.badgeRow}>
            <StatBadge label="Entries" value={`${ctx.length}`} />
            ...
            {ctx.map((e, i) => (
              <View key={i} style={styles.memEntry}>
                <View
                  style={[
                    styles.memBadge,
                    e.role === 'user' ? styles.memBadgeU : styles.memBadgeA,
                  ]}
                >
      ...
      <View style={styles.inputBar}>
        ...
        <TouchableOpacity
          style={[
            styles.sendBtn,
            (!input.trim() || isProcessing) && styles.sendDis,
          ]}
          onPress={handleSend}
...
const styles = StyleSheet.create({
  ...
  memBadgeU: {backgroundColor: '#007AFF'},
  memBadgeA: {backgroundColor: '#34C759'},
