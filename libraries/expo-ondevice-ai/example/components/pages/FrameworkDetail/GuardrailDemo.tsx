...
export function GuardrailDemo() {
  ...
  const handleRun = async () => {
    ...
    try {
      console.log(
        '[DEBUG] guardrail summarize request:',
        JSON.stringify({inputLength: input.length}),
      );
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TextInput
        ...
        placeholderTextColor="#999"
      />
      <Text style={[styles.charCount, isOverLimit && styles.charCountErr]}>
      ...
      >
        {isProcessing ? (
          ...
          <Text style={styles.runBtnText}>Run with Guardrails</Text>
        )}
      </TouchableOpacity>
      {result && (
        <View
