...
/** Serializes Locanara SDK result types into Flutter-compatible maps */
object FlutterOndeviceAiSerialization {
    ...
    /** Convert FeatureType enum to camelCase key for Flutter */
