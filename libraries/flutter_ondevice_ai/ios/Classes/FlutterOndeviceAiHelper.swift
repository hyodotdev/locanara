...
/// Decodes Flutter options dictionaries into chain constructor parameters
@available(iOS 15.0, macOS 14.0, *)
enum FlutterOndeviceAiHelper {
...
/// Memory adapter that provides pre-filled chat history from Flutter.
@available(iOS 15.0, macOS 14.0, *)
