...
>
> **Historical research snapshot, not a dependency pin.** llama.cpp changes
> continuously; verify the resolved LocalLLMClient revision, upstream headers,
> and current official repository before using any API/version claim below.
