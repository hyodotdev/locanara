  ...
  process.stdout.write(chunk);
      ...
      <section>
        ...
        <CodeBlock
          language="typescript"
          code={`// From Blob
const result = await locanara.describeImage(imageBlob);

// From HTMLImageElement
const result = await locanara.describeImage(imgElement);

// From HTMLCanvasElement
const result = await locanara.describeImage(canvas);

// From ImageData
const result = await locanara.describeImage(imageData);
...
for await (const chunk of locanara.writeStreaming(myPrompt)) {
  process.stdout.write(chunk);
      ...
      <PageNavigation
        prev={{ to: "/docs/apis/android", label: "Android APIs" }}
      />
    </div>
  );
}
