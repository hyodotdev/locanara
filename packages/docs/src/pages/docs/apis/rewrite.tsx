...
function RewriteAPI() {
  return (
    <div className="doc-page">
      <SEO
        title="Rewrite API"
        description="Locanara rewrite API - Rephrase text with different styles using on-device AI."
...
//          the project details. Please let me know your availability."`}</CodeBlock>
      ...
      <PageNavigation
        prev={{ to: "/docs/apis/translate", label: "translate()" }}
        next={{ to: "/docs/apis/proofread", label: "proofread()" }}
      />
    </div>
  );
}
